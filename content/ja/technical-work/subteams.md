...
<div class="row">
  <div class="col-12 col-md-6 col-lg-3 mb-4">
    <div class="card text-center h-100" style="border: none; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
      ...
      <div class="card-body">
        <h4 class="card-title" style="margin-bottom: 1rem;">自動運転 (Autonomy)</h4>
        <p class="card-text">ASVのための認識、自己位置推定、計画システム。</p>
      </div>
    </div>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-3 mb-4">
    <a href="https://ouxt-polaris.github.io/ouxt_automation/circuit/computer_sensor_board/computer_sensor_board/" target="_blank" rel="noopener" style="text-decoration: none; color: inherit;">
      <div class="card text-center h-100" style="border: none; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transition: transform 0.2s;">
        ...
        <div class="card-body">
          <h4 class="card-title" style="margin-bottom: 1rem;">電気 (Electrical)</h4>
          <p class="card-text">配電、センシング、搭載電子機器。</p>
        </div>
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-3 mb-4">
    <a href="/reports/mechanical-report" style="text-decoration: none; color: inherit;">
      <div class="card text-center h-100" style="border: none; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transition: transform 0.2s;">
        ...
        <div class="card-body">
          <h4 class="card-title" style="margin-bottom: 1rem;">機械 (Mechanical)</h4>
          <p class="card-text">船体設計、推進統合、機械システム。</p>
        </div>
      </div>
    </a>
  </div>
  ...
  <div class="col-12 col-md-6 col-lg-3 mb-4">
    <a href="/reports/testing-report" style="text-decoration: none; color: inherit;">
      <div class="card text-center h-100" style="border: none; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transition: transform 0.2s;">
        ...
        <div class="card-body">
          <h4 class="card-title" style="margin-bottom: 1rem;">テスト (Testing)</h4>
          <p class="card-text">システム統合、テスト手順、検証。</p>
        </div>
      </div>
    </a>
  </div>
